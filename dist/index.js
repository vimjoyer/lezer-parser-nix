...
const nixHighlighting = styleTags({
    Identifier: tags.propertyName,
    TRUE: tags.bool,
    WITH: tags.bool,
    MarkCurlyOpen: tags.integer,
    ...
    IN: tags.keyword,
    OR_KW: tags.keyword,
    INHERIT: tags.keyword,
    REC: tags.keyword,
    AttrInterpolation: tags.keyword,
    float: tags.keyword,
    Float: tags.keyword,
    Parens: tags.keyword,
    FormalsRest: tags.keyword,
    
    PathAbsolute: tags.link,
    PathHome: tags.link,
    PathLibrary: tags.link,
    PathRelative: tags.link,
    PathRaw: tags.link,
    PathContent: tags.link,
    PathComponent: tags.link,
    uriPath: tags.link,
    uriSchema: tags.link,
    StringStart: tags.string,
    StringEnd: tags.string,
